import { isDevMode, Injectable, Component, Input, HostBinding, Inject, Output, EventEmitter, Directive, ElementRef, Renderer2, NgModule, ChangeDetectionStrategy, ChangeDetectorRef, forwardRef, HostListener, Optional, NgZone, Injector, TemplateRef, ApplicationRef, ComponentFactoryResolver, ViewContainerRef, Host, ViewChild, RendererFactory2, ViewEncapsulation, ViewChildren } from '@angular/core';
 ...
 * JS version of browser APIs. This library can only run in the browser.
 */
var /** @type {?} */ win$1 = (typeof window !== 'undefined' && window) || /** @type {?} */ ({});
var /** @type {?} */ document$1$1 = win$1.document;
var /** @type {?} */ location$1 = win$1.location;
var /** @type {?} */ gc$1 = win$1.gc ? function () { return win$1.gc(); } : function () { return null; };
var /** @type {?} */ performance$1 = win$1.performance ? win$1.performance : null;
var /** @type {?} */ Event$1 = win$1.Event;
var /** @type {?} */ MouseEvent$1 = win$1.MouseEvent;
var /** @type {?} */ KeyboardEvent$1 = win$1.KeyboardEvent;
var /** @type {?} */ EventTarget$1 = win$1.EventTarget;
var /** @type {?} */ History$1 = win$1.History;
var /** @type {?} */ Location$1 = win$1.Location;
var /** @type {?} */ EventListener$1 = win$1.EventListener;

/**
 * @fileoverview added by tsickle
 * @suppress {checkTypes} checked by tsc
 */
var /** @type {?} */ guessedVersion$1;
/**
 * @return {?}
 */
function _guessBsVersion$1() {
    if (typeof document === 'undefined') {
        return null;
    }
...
function isBs3$1() {
    ...
    if (typeof win$1.__theme === 'undefined') {
        if (guessedVersion$1) {
            return guessedVersion$1 === 'bs3';
        }
        guessedVersion$1 = _guessBsVersion$1();
        return guessedVersion$1 === 'bs3';
    }
...
CollapseDirective$1.decorators = [
    { type: Directive, args: [{
                selector: '[collapse]',
                exportAs: 'bs-collapse',
                host: {
...
/** @nocollapse */
CollapseDirective$1.ctorParameters = () => [
    { type: ElementRef, },
    { type: Renderer2, },
];
CollapseDirective$1.propDecorators = {
    "collapsed": [{ type: Output },],
    "expanded": [{ type: Output },],
    "display": [{ type: HostBinding, args: ['style.display',] },],
    "isExpanded": [{ type: HostBinding, args: ['class.in',] }, { type: HostBinding, args: ['class.show',] }, { type: HostBinding, args: ['attr.aria-expanded',] },],
...
class CollapseModule$1 {
    static forRoot() {
        return { ngModule: CollapseModule$1, providers: [] };
    }
}
CollapseModule$1.decorators = [
    { type: NgModule, args: [{
                declarations: [CollapseDirective$1],
                exports: [CollapseDirective$1]
            },] },
];
 ...
 * @return {?}
 */
function hasOwnProp$1(a /*object*/, b) {
    return Object.prototype.hasOwnProperty.call(a, b);
}
/**
 * @template T
 ...
 * @return {?}
 */
function isObject$1(input /*object*/) {
    // IE8 will treat undefined and null as object if it wasn't for
    // input != null
    return (input != null && Object.prototype.toString.call(input) === '[object Object]');
}
...
function addUnitAlias$1(unit, shorthand) {
    ...
    var /** @type {?} */ _unit = unit;
    if (lowerCase in _mapUnits$1) {
        _unit = _mapUnits$1[lowerCase];
    }
    aliases$1[lowerCase] = aliases$1[lowerCase + "s"] = aliases$1[shorthand] = _unit;
}
/**
 * @param {?} units
 * @return {?}
...
function normalizeUnits$1(units) {
    return isString$1(units) ? aliases$1[units] || aliases$1[units.toLowerCase()] : undefined;
}
/**
 * @param {?} inputObject
 * @return {?}
...
var /** @type {?} */ MINUTE$1 = 4;
var /** @type {?} */ SECOND$1 = 5;
var /** @type {?} */ MILLISECOND$1 = 6;
var /** @type {?} */ WEEK$1 = 7;
var /** @type {?} */ WEEKDAY$1 = 8;
 ...
 * @return {?}
 */
function zeroFill$1(num, targetLength, forceSign) {
 ...
 * @suppress {checkTypes} checked by tsc
 */
var /** @type {?} */ formatFunctions$1 = {};
var /** @type {?} */ formatTokenFunctions$1 = {};
// tslint:disable-next-line
var /** @type {?} */ formattingTokens$1 = /(\[[^\[]*\])|(\\)?([Hh]mm(ss)?|Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Qo?|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|kk?|mm?|ss?|S{1,9}|x|X|zz?|ZZ?|.)/g;
/**
 * @param {?} token
 * @param {?} padded
 * @param {?} ordinal
 ...
 * @return {?}
 */
function addFormatToken$1(token, padded, ordinal, callback) {
    if (token) {
        formatTokenFunctions$1[token] = callback;
    }
    if (padded) {
        formatTokenFunctions$1[padded[0]] = function () {
            return zeroFill$1(callback.apply(null, arguments), padded[1], padded[2]);
        };
    }
    if (ordinal) {
        formatTokenFunctions$1[ordinal] = function (date, opts) {
            return opts.locale.ordinal(callback.apply(null, arguments), token);
        };
    }
}
 ...
 * @return {?}
 */
function makeFormatFunction$1(format) {
    var /** @type {?} */ array = format.match(formattingTokens$1);
    var /** @type {?} */ length = array.length;
    var /** @type {?} */ formatArr = new Array(length);
    for (var /** @type {?} */ i = 0; i < length; i++) {
        formatArr[i] = formatTokenFunctions$1[array[i]]
            ? formatTokenFunctions$1[array[i]]
            : removeFormattingTokens$1(array[i]);
    }
    return function (date, locale, isUTC, offset) {
        if (offset === void 0) { offset = 0; }
        var /** @type {?} */ output = '';
        for (var /** @type {?} */ j = 0; j < length; j++) {
            output += isFunction$1(formatArr[j])
 ...
 * @return {?}
 */
function createUTCDate$1(y, m, d) {
 ...
 * @return {?}
 */
function getHours$1(date, isUTC) {
 ...
 * @return {?}
 */
function getMinutes$1(date, isUTC) {
    if (isUTC === void 0) { isUTC = false; }
    return isUTC ? date.getUTCMinutes() : date.getMinutes();
}
/**
 ...
 * @return {?}
 */
function getSeconds$1(date, isUTC) {
    if (isUTC === void 0) { isUTC = false; }
    return isUTC ? date.getUTCSeconds() : date.getSeconds();
}
/**
 ...
 * @return {?}
 */
function getMilliseconds$1(date, isUTC) {
    if (isUTC === void 0) { isUTC = false; }
    return isUTC ? date.getUTCMilliseconds() : date.getMilliseconds();
}
/**
 ...
 * @return {?}
 */
function getMonth$1(date, isUTC) {
    if (isUTC === void 0) { isUTC = false; }
    return isUTC ? date.getUTCMonth() : date.getMonth();
}
/**
 ...
 * @return {?}
 */
function getFullYear$1(date, isUTC) {
    if (isUTC === void 0) { isUTC = false; }
    return isUTC ? date.getUTCFullYear() : date.getFullYear();
}
/**
 ...
 * @return {?}
 */
function getFirstDayOfMonth$1(date) {
    return createDate$1(date.getFullYear(), date.getMonth(), 1, date.getHours(), date.getMinutes(), date.getSeconds());
}
/**
 * @param {?} date
 ...
 * @return {?}
 */
function isFirstDayOfWeek$1(date, firstDayOfWeek) {
    return date.getDay() === firstDayOfWeek;
}
/**
 * @param {?} date1
...
function isSameMonth$1(date1, date2) {
    ...
    return isSameYear$1(date1, date2) && getMonth$1(date1) === getMonth$1(date2);
}
/**
 * @param {?} date1
 * @param {?} date2
...
function isSameYear$1(date1, date2) {
    ...
    return getFullYear$1(date1) === getFullYear$1(date2);
}
/**
 * @param {?} date1
 * @param {?} date2
 * @return {?}
 */
function isSameDay$2(date1, date2) {
    if (!date1 || !date2) {
        return false;
    }
    return (isSameYear$1(date1, date2) &&
        isSameMonth$1(date1, date2) &&
        getDate$1(date1) === getDate$1(date2));
}
 ...
 * @suppress {checkTypes} checked by tsc
 */
var /** @type {?} */ match1$1 = /\d/; //       0 - 9
var /** @type {?} */ match2$1 = /\d\d/; //      00 - 99
var /** @type {?} */ match3$1 = /\d{3}/; //     000 - 999
var /** @type {?} */ match4$1 = /\d{4}/; //    0000 - 9999
var /** @type {?} */ match6$1 = /[+-]?\d{6}/; // -999999 - 999999
var /** @type {?} */ match1to2$1 = /\d\d?/; //       0 - 99
var /** @type {?} */ match3to4$1 = /\d\d\d\d?/; //     999 - 9999
var /** @type {?} */ match5to6$1 = /\d\d\d\d\d\d?/; //   99999 - 999999
var /** @type {?} */ match1to3$1 = /\d{1,3}/; //       0 - 999
var /** @type {?} */ match1to4$1 = /\d{1,4}/; //       0 - 9999
var /** @type {?} */ match1to6$1 = /[+-]?\d{1,6}/; // -999999 - 999999
var /** @type {?} */ matchUnsigned$1 = /\d+/; //       0 - inf
var /** @type {?} */ matchSigned$1 = /[+-]?\d+/; //    -inf - inf
var /** @type {?} */ matchShortOffset$1 = /Z|[+-]\d\d(?::?\d\d)?/gi; // +00 -00 +00:00 -00:00 +0000 -0000 or Z
var /** @type {?} */ matchTimestamp$1 = /[+-]?\d+(\.\d{1,3})?/; // 123456789 123456789.123
// any word (or two) characters or numbers including two/three word month in arabic.
// includes scottish gaelic two word and hyphenated months
// tslint:disable-next-line
var /** @type {?} */ matchWord$1 = /[0-9]{0,256}['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]{1,256}|[\u0600-\u06FF\/]{1,256}(\s*?[\u0600-\u06FF]{1,256}){1,2}/i;
var /** @type {?} */ regexes$1 = {};
/**
 * @param {?} token
 * @param {?} regex
 ...
 * @return {?}
 */
function addRegexToken$1(token, regex, strictRegex) {
    if (isFunction$1(regex)) {
        regexes$1[token] = regex;
        return;
    }
    regexes$1[token] = function (isStrict, locale) {
        return (isStrict && strictRegex) ? strictRegex : regex;
    };
}
/**
 ...
 * @return {?}
 */
function getParseRegexForToken$1(token, locale) {
    var /** @type {?} */ _strict = false;
    if (!hasOwnProp$1(regexes$1, token)) {
        return new RegExp(unescapeFormat$1(token));
    }
    return regexes$1[token](_strict, locale);
}
/**
 * @param {?} str
 * @return {?}
 */
function unescapeFormat$1(str) {
    // tslint:disable-next-line
    return regexEscape$1(str
        .replace('\\', '')
 ...
 * @return {?}
 */
function addParseToken$1(token, callback) {
    var /** @type {?} */ _token = isString$1(token) ? [token] : token;
    ...
    if (isArray$1(_token) && isFunction$1(func)) {
        var /** @type {?} */ i = void 0;
        for (i = 0; i < _token.length; i++) {
            tokens$1[_token[i]] = func;
        }
    }
}
/**
 ...
 * @return {?}
 */
function addWeekParseToken$1(token, callback) {
    addParseToken$1(token, function (input, array, config, _token) {
        config._w = config._w || {};
        return callback(input, config._w, config, _token);
    });
}
 ...
 * @return {?}
 */
function addTimeToArrayFromToken$1(token, input, config) {
    if (input != null && hasOwnProp$1(tokens$1, token)) {
        tokens$1[token](input, config._a, config, token);
    }
    return config;
}
 ...
 * @return {?}
 */
function getParsingFlags$1(config) {
    if (config._pf == null) {
        config._pf = defaultParsingFlags$1();
    }
    return config._pf;
}
 ...
 * @return {?}
 */
function parseTwoDigitYear$1(input) {
 ...
 * @return {?}
 */
function daysInMonth$1$1(year, month) {
    if (isNaN(year) || isNaN(month)) {
        return NaN;
    }
    var /** @type {?} */ modMonth = mod$1(month, 12);
 ...
 * @return {?}
 */
function shiftDate$1(date, unit) {
    var /** @type {?} */ _unit = Object.assign({}, defaultTimeUnit$1, unit);
    ...
    if (_unit.month && !_unit.day) {
        day = Math.min(day, daysInMonth$1$1(year, month));
    }
    return createDate$1(year, month, day, date.getHours() + (_unit.hour || 0), date.getMinutes() + (_unit.minute || 0), date.getSeconds() + (_unit.seconds || 0));
}
/**
 * @param {?} date
 * @param {?} unit
 * @return {?}
 */
function setFullDate$1(date, unit) {
    return createDate$1(getNum$1(date.getFullYear(), unit.year), getNum$1(date.getMonth(), unit.month), getNum$1(date.getDate(), unit.day), getNum$1(date.getHours(), unit.hour), getNum$1(date.getMinutes(), unit.minute), getNum$1(date.getSeconds(), unit.seconds), getNum$1(date.getMilliseconds(), unit.milliseconds));
}
/**
 * @param {?} def
 * @param {?=} num
 * @return {?}
 */
function getNum$1(def, num) {
    return isNumber$1(num) ? num : def;
}
/**
 * @param {?} date
 * @param {?} value
 ...
 * @return {?}
 */
function setMonth$1(date, value, isUTC) {
    var /** @type {?} */ dayOfMonth = Math.min(getDate$1(date), daysInMonth$1$1(getFullYear$1(date), value));
    isUTC ? date.setUTCMonth(value, dayOfMonth) : date.setMonth(value, dayOfMonth);
    return date;
}
/**
 ...
 * @return {?}
 */
function setHours$1(date, value, isUTC) {
    isUTC ? date.setUTCHours(value) : date.setHours(value);
    return date;
}
/**
 ...
 * @return {?}
 */
function setMinutes$1(date, value, isUTC) {
    isUTC ? date.setUTCMinutes(value) : date.setMinutes(value);
    return date;
}
/**
 ...
 * @return {?}
 */
function setSeconds$1(date, value, isUTC) {
    isUTC ? date.setUTCSeconds(value) : date.setSeconds(value);
    return date;
}
/**
 ...
 * @return {?}
 */
function setMilliseconds$1(date, value, isUTC) {
    isUTC ? date.setUTCMilliseconds(value) : date.setMilliseconds(value);
    return date;
}
/**
 ...
 * @return {?}
 */
function setDate$1(date, value, isUTC) {
    isUTC ? date.setUTCDate(value) : date.setDate(value);
    return date;
}
/**
 ...
 * @return {?}
 */
function startOf$1(date, unit, isUTC) {
    var /** @type {?} */ _date = cloneDate$1(date);
    // the following switch intentionally omits break keywords
    // to utilize falling through the cases.
    switch (unit) {
        case 'year':
            setMonth$1(_date, 0, isUTC);
        /* falls through */
        case 'quarter':
        case 'month':
            setDate$1(_date, 1, isUTC);
        /* falls through */
        case 'week':
        case 'isoWeek':
        case 'day':
        case 'date':
            setHours$1(_date, 0, isUTC);
        /* falls through */
        case 'hours':
            setMinutes$1(_date, 0, isUTC);
        /* falls through */
        case 'minutes':
            setSeconds$1(_date, 0, isUTC);
        /* falls through */
        case 'seconds':
            setMilliseconds$1(_date, 0, isUTC);
    }
    // weeks are a special case
    if (unit === 'week') {
        setLocaleDayOfWeek$1(_date, 0, { isUTC: isUTC });
    }
    if (unit === 'isoWeek') {
        setISODayOfWeek$1(_date, 1);
    }
    // quarters are also special
    if (unit === 'quarter') {
        setMonth$1(_date, Math.floor(getMonth$1(_date, isUTC) / 3) * 3, isUTC);
    }
    return _date;
}
/**
 ...
 * @return {?}
 */
function endOf$1(date, unit, isUTC) {
    var /** @type {?} */ _unit = unit;
    // 'date' is an alias for 'day', so it should be considered as such.
    if (_unit === 'date') {
        _unit = 'day';
    }
    var /** @type {?} */ start = startOf$1(date, _unit, isUTC);
    var /** @type {?} */ _step = add$1(start, 1, _unit === 'isoWeek' ? 'week' : _unit, isUTC);
    var /** @type {?} */ res = subtract$1(_step, 1, 'milliseconds', isUTC);
    return res;
}
 ...
 * @return {?}
 */
function getDayOfYear$1(date, isUTC) {
    var /** @type {?} */ date1 = +startOf$1(date, 'day', isUTC);
    var /** @type {?} */ date2 = +startOf$1(date, 'year', isUTC);
...
function firstWeekOffset$1(year, dow, doy) {
    ...
    // first-week day local weekday -- which local weekday is fwd
    var /** @type {?} */ fwdlw = (createUTCDate$1(year, 0, fwd).getUTCDay() - dow + 7) % 7;
    return -fwdlw + fwd - 1;
}
/**
 * @param {?} year
...
function dayOfYearFromWeeks$1(year, week, weekday, dow, doy) {
    ...
    var /** @type {?} */ weekOffset = firstWeekOffset$1(year, dow, doy);
 ...
 * @return {?}
 */
function weekOfYear$1(date, dow, doy, isUTC) {
    var /** @type {?} */ weekOffset = firstWeekOffset$1(getFullYear$1(date, isUTC), dow, doy);
    var /** @type {?} */ week = Math.floor((getDayOfYear$1(date, isUTC) - weekOffset - 1) / 7) + 1;
    var /** @type {?} */ resWeek;
    var /** @type {?} */ resYear;
    if (week < 1) {
        resYear = getFullYear$1(date, isUTC) - 1;
        resWeek = week + weeksInYear$1(resYear, dow, doy);
    }
    else if (week > weeksInYear$1(getFullYear$1(date, isUTC), dow, doy)) {
        resWeek = week - weeksInYear$1(getFullYear$1(date, isUTC), dow, doy);
        resYear = getFullYear$1(date, isUTC) + 1;
    }
    else {
        resYear = getFullYear$1(date, isUTC);
        resWeek = week;
    }
    return {
        week: resWeek,
...
function weeksInYear$1(year, dow, doy) {
    var /** @type {?} */ weekOffset = firstWeekOffset$1(year, dow, doy);
    var /** @type {?} */ weekOffsetNext = firstWeekOffset$1(year + 1, dow, doy);
 ...
 * @suppress {checkTypes} checked by tsc
 */
var /** @type {?} */ MONTHS_IN_FORMAT$1 = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/;
var /** @type {?} */ defaultLocaleMonths$1 = 'January_February_March_April_May_June_July_August_September_October_November_December'.split('_');
var /** @type {?} */ defaultLocaleMonthsShort$1 = 'Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec'.split('_');
var /** @type {?} */ defaultLocaleWeekdays$1 = 'Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday'.split('_');
var /** @type {?} */ defaultLocaleWeekdaysShort$1 = 'Sun_Mon_Tue_Wed_Thu_Fri_Sat'.split('_');
var /** @type {?} */ defaultLocaleWeekdaysMin$1 = 'Su_Mo_Tu_We_Th_Fr_Sa'.split('_');
var /** @type {?} */ defaultLongDateFormat$1 = {
    LTS: 'h:mm:ss A',
    LT: 'h:mm A',
    L: 'MM/DD/YYYY',
    LL: 'MMMM D, YYYY',
...
var /** @type {?} */ defaultOrdinal$1 = '%d';
var /** @type {?} */ defaultDayOfMonthOrdinalParse$1 = /\d{1,2}/;
var /** @type {?} */ defaultMonthsShortRegex$1 = matchWord$1;
var /** @type {?} */ defaultMonthsRegex$1 = matchWord$1;
var Locale$1 = /** @class */ (function () {
    ...
    function (config) {
        ...
        for (confKey in config) {
            ...
            var /** @type {?} */ key = /** @type {?} */ ((isFunction$1(prop) ? confKey : "_" + confKey));
            this[key] = /** @type {?} */ (prop);
        }
        this._config = config;
    };
    ...
    function (key, date, now) {
        ...
        return isFunction$1(output) ? output.call(null, date, now) : output;
    };
    /**
     * @param {?} key
     * @return {?}
    ...
    function (date, format, isUTC) {
        ...
        if (isArray$1(this._months)) {
            return this._months[getMonth$1(date, isUTC)];
        }
        var /** @type {?} */ key = (this._months.isFormat || MONTHS_IN_FORMAT$1).test(format)
            ? 'format'
            : 'standalone';
        return this._months[key][getMonth$1(date, isUTC)];
    };
    /**
     * @param {?=} date
     * @param {?=} format
    ...
    function (date, format, isUTC) {
        ...
        if (isArray$1(this._monthsShort)) {
            return this._monthsShort[getMonth$1(date, isUTC)];
        }
        var /** @type {?} */ key = MONTHS_IN_FORMAT$1.test(format) ? 'format' : 'standalone';
        return this._monthsShort[key][getMonth$1(date, isUTC)];
    };
    /**
     * @param {?} monthName
     * @param {?=} format
     ...
     */
    function (date, isUTC) {
        return weekOfYear$1(date, this._week.dow, this._week.doy, isUTC).week;
    };
    /**
     * @return {?}
     */
    ...
    function (date, format, isUTC) {
        ...
        if (isArray$1(this._weekdays)) {
            return this._weekdays[getDay$1(date, isUTC)];
        }
        var /** @type {?} */ _key = this._weekdays.isFormat.test(format)
            ? 'format'
            : 'standalone';
        return this._weekdays[_key][getDay$1(date, isUTC)];
    };
    /**
     * @param {?=} date
     * @param {?=} format
     ...
     */
    function (date, format, isUTC) {
        return date ? this._weekdaysMin[getDay$1(date, isUTC)] : this._weekdaysMin;
    };
    /**
     * @param {?=} date
     * @param {?=} format
     ...
     */
    function (date, format, isUTC) {
        return date ? this._weekdaysShort[getDay$1(date, isUTC)] : this._weekdaysShort;
    };
    // proto.weekdaysParse  =        localeWeekdaysParse;
    /**
     * @param {?=} weekdayName
    ...
    function (weekdayName, format, strict) {
        ...
        for (i = 0; i < 7; i++) {
            // make the regex if we don't have it already
            // fix: here is the issue
            var /** @type {?} */ date = setDayOfWeek$1(new Date(Date.UTC(2000, 1)), i, null, true);
            if (strict && !this._fullWeekdaysParse[i]) {
                this._fullWeekdaysParse[i] = new RegExp("^" + this.weekdays(date, '', true).replace('.', '\.?') + "$", 'i');
                this._shortWeekdaysParse[i] = new RegExp("^" + this.weekdaysShort(date, '', true).replace('.', '\.?') + "$", 'i');
                this._minWeekdaysParse[i] = new RegExp("^" + this.weekdaysMin(date, '', true).replace('.', '\.?') + "$", 'i');
            ...
            if (!isArray$1(this._fullWeekdaysParse)
                || !isArray$1(this._shortWeekdaysParse)
                || !isArray$1(this._minWeekdaysParse)
                || !isArray$1(this._weekdaysParse)) {
                return;
            }
            // test the regex
            if (strict && format === 'dddd' && this._fullWeekdaysParse[i].test(weekdayName)) {
    ...
    function (isStrict) {
        if (this._weekdaysParseExact) {
            ...
            if (!hasOwnProp$1(this, '_weekdaysRegex')) {
                this._weekdaysRegex = matchWord$1;
            }
            return this._weekdaysStrictRegex && isStrict ?
                this._weekdaysStrictRegex : this._weekdaysRegex;
        }
    ...
    function (isStrict) {
        if (this._weekdaysParseExact) {
            ...
            if (!hasOwnProp$1(this, '_weekdaysShortRegex')) {
                this._weekdaysShortRegex = matchWord$1;
            }
            return this._weekdaysShortStrictRegex && isStrict ?
                this._weekdaysShortStrictRegex : this._weekdaysShortRegex;
        }
    ...
    function (isStrict) {
        if (this._weekdaysParseExact) {
            ...
            if (!hasOwnProp$1(this, '_weekdaysMinRegex')) {
                this._weekdaysMinRegex = matchWord$1;
            }
            return this._weekdaysMinStrictRegex && isStrict ?
                this._weekdaysMinStrictRegex : this._weekdaysMinRegex;
        }
     ...
     */
    function (key) {
        this._longDateFormat = this._longDateFormat ? this._longDateFormat : defaultLongDateFormat$1;
        var /** @type {?} */ format = this._longDateFormat[key];
        var /** @type {?} */ formatUpper = this._longDateFormat[key.toUpperCase()];
        if (format || !formatUpper) {
            return format;
    ...
    function (weekdayName, format, strict) {
        ...
        if (!isArray$1(this._weekdaysParse)
            || !isArray$1(this._shortWeekdaysParse)
            || !isArray$1(this._minWeekdaysParse)) {
            return;
        }
    ...
    function () {
        ...
        // Sorting makes sure if one month (or abbr) is a prefix of another it
        // will match the longer piece.
        shortPieces.sort(cmpLenRev$1);
        longPieces.sort(cmpLenRev$1);
        mixedPieces.sort(cmpLenRev$1);
        for (i = 0; i < 12; i++) {
 ...
 * @suppress {checkTypes} checked by tsc
 */
var /** @type {?} */ defaultInvalidDate$1 = 'Invalid date';
var /** @type {?} */ defaultLocaleWeek$1 = {
    dow: 0,
    // Sunday is the first day of the week.
    doy: 6 // The week that contains Jan 1st is the first week of the year.
};
var /** @type {?} */ defaultLocaleMeridiemParse$1 = /[ap]\.?m?\.?/i;
var /** @type {?} */ defaultRelativeTime$1 = {
    future: 'in %s',
    past: '%s ago',
    s: 'a few seconds',
    ss: '%d seconds',
...
function compareArrays$1(array1, array2, dontConvert) {
    ...
    for (i = 0; i < len; i++) {
        if ((dontConvert && array1[i] !== array2[i])
            || (!dontConvert && toInt$1(array1[i]) !== toInt$1(array2[i]))) {
            diffs++;
        }
    }
    return diffs + lengthDiff;
...
function chooseLocale$1(names) {
    ...
    var /** @type {?} */ i = 0;
    while (i < names.length) {
        var /** @type {?} */ split = normalizeLocale$1(names[i]).split('-');
        var /** @type {?} */ j = split.length;
        next = normalizeLocale$1(names[i + 1]);
        next = next ? next.split('-') : null;
        while (j > 0) {
            locale = loadLocale$1(split.slice(0, j).join('-'));
            if (locale) {
                return locale;
            }
            if (next && next.length >= j && compareArrays$1(split, next, true) >= j - 1) {
                // the next array item is better than a shallower substring of this one
                break;
            }
            j--;
...
function mergeConfigs$1(parentConfig, childConfig) {
    ...
    for (var /** @type {?} */ childProp in childConfig) {
        if (!hasOwnProp$1(childConfig, childProp)) {
            continue;
        }
        if (isObject$1(parentConfig[childProp]) && isObject$1(childConfig[childProp])) {
            res[childProp] = {};
            Object.assign(res[childProp], parentConfig[childProp]);
            Object.assign(res[childProp], childConfig[childProp]);
        }
    ...
    var /** @type {?} */ parentProp;
    for (parentProp in parentConfig) {
        if (hasOwnProp$1(parentConfig, parentProp) &&
            !hasOwnProp$1(childConfig, parentProp) &&
            isObject$1(parentConfig[/** @type {?} */ (parentProp)])) {
            // make sure changes to properties don't modify parent config
...
function getSetGlobalLocale$1(key, values) {
    ...
    if (key) {
        ...
        else if (isString$1(key)) {
            data = defineLocale$1(key, values);
        }
        if (data) {
            globalLocale$1 = data;
        }
    }
    return globalLocale$1 && globalLocale$1._abbr;
}
/**
 * @param {?} name
 * @param {?=} config
...
function defineLocale$1(name, config) {
    if (config === null) {
        ...
        globalLocale$1 = getLocale$1('en');
        return null;
    }
    if (!config) {
        return;
    }
    var /** @type {?} */ parentConfig = baseConfig$1;
    config.abbr = name;
    if (config.parentLocale != null) {
        if (locales$1[config.parentLocale] != null) {
            ...
            localeFamilies$1[config.parentLocale].push({ name: name, config: config });
            return null;
        }
    }
 ...
 * @suppress {checkTypes} checked by tsc
 */
var /** @type {?} */ ordering$1 = ['year', 'quarter', 'month', 'week', 'day', 'hours', 'minutes', 'seconds', 'milliseconds'];
var ɵ0$1 = function (mem, order) {
    mem[order] = true;
    return mem;
};
var /** @type {?} */ orderingHash$1 = ordering$1.reduce(ɵ0$1, {});
/**
 * @param {?} duration
 * @return {?}
 */
function isDurationValid$1(duration) {
    var /** @type {?} */ durationKeys = Object.keys(duration);
    if (durationKeys
        .some(function (key) {
        return (key in orderingHash$1)
            && duration[key] === null
            || isNaN(duration[key]);
    })) {
        return false;
    ...
    for (var /** @type {?} */ i = 0; i < ordering$1.length; ++i) {
        if (duration[ordering$1[i]]) {
            // only allow non-integers for smallest unit
            if (unitHasDecimal) {
                return false;
            }
            if (duration[ordering$1[i]] !== toInt$1(duration[ordering$1[i]])) {
                unitHasDecimal = true;
            }
        }
    }
...
function bubble$1(dur) {
    ...
    if (!((milliseconds >= 0 && days >= 0 && months >= 0) ||
        (milliseconds <= 0 && days <= 0 && months <= 0))) {
        milliseconds += absCeil$1(monthsToDays$1(months) + days) * 864e5;
        days = 0;
        months = 0;
    }
    // The following code bubbles up values, see the tests for
    // examples of what that means.
    data.milliseconds = milliseconds % 1000;
    var /** @type {?} */ seconds = absFloor$1(milliseconds / 1000);
    data.seconds = seconds % 60;
    var /** @type {?} */ minutes = absFloor$1(seconds / 60);
    data.minutes = minutes % 60;
    var /** @type {?} */ hours = absFloor$1(minutes / 60);
    data.hours = hours % 24;
    days += absFloor$1(hours / 24);
    // convert days to months
    var /** @type {?} */ monthsFromDays = absFloor$1(daysToMonths$1(days));
    months += monthsFromDays;
    days -= absCeil$1(monthsToDays$1(monthsFromDays));
    // 12 months -> 1 year
    var /** @type {?} */ years = absFloor$1(months / 12);
    months %= 12;
    data.day = days;
    data.month = months;
    data.year = years;
 ...
 * @suppress {checkTypes} checked by tsc
 */
var /** @type {?} */ round$1 = Math.round;
var /** @type {?} */ thresholds$1 = {
    ss: 44,
    // a few seconds to seconds
    s: 45,
    // seconds to minute
 ...
 * @return {?}
 */
function substituteTimeAgo$1(str, num, withoutSuffix, isFuture, locale) {
    return locale.relativeTime(num || 1, !!withoutSuffix, str, isFuture);
}
/**
...
function relativeTime$1(posNegDuration, withoutSuffix, locale) {
    var /** @type {?} */ duration = createDuration$1(posNegDuration).abs();
    var /** @type {?} */ seconds = round$1(duration.as('s'));
    var /** @type {?} */ minutes = round$1(duration.as('m'));
    var /** @type {?} */ hours = round$1(duration.as('h'));
    var /** @type {?} */ days = round$1(duration.as('d'));
    var /** @type {?} */ months = round$1(duration.as('M'));
    var /** @type {?} */ years = round$1(duration.as('y'));
    var /** @type {?} */ a = seconds <= thresholds$1["ss"] && ['s', seconds] ||
        seconds < thresholds$1["s"] && ['ss', seconds] ||
        minutes <= 1 && ['m'] ||
        minutes < thresholds$1["m"] && ['mm', minutes] ||
        hours <= 1 && ['h'] ||
        hours < thresholds$1["h"] && ['hh', hours] ||
        days <= 1 && ['d'] ||
        days < thresholds$1["d"] && ['dd', days] ||
        months <= 1 && ['M'] ||
        months < thresholds$1["M"] && ['MM', months] ||
        years <= 1 && ['y'] || ['yy', years];
    var /** @type {?} */ b = [a[0], a[1], withoutSuffix, +posNegDuration > 0, locale];
    // a[2] = withoutSuffix;
    // a[3] = +posNegDuration > 0;
    // a[4] = locale;
    return substituteTimeAgo$1.apply(null, b);
}
// export function humanize(withSuffix) {
//   if (!this.isValid()) {
//     return this.localeData().invalidDate();
 ...
 * @suppress {checkTypes} checked by tsc
 */
var Duration$1 = /** @class */ (function () {
    function Duration(duration, config) {
        if (config === void 0) { config = {}; }
        this._data = {};
        this._locale = getLocale$1();
        this._locale = config && config._locale || getLocale$1();
        // const normalizedInput = normalizeObjectUnits(duration);
    ...
    function (withSuffix) {
        ...
        var /** @type {?} */ output = relativeTime$1(this, !withSuffix, locale);
        if (withSuffix) {
            output = locale.pastFuture(+this, output);
        }
        return locale.postformat(output);
    ...
    function (localeKey) {
        ...
        this._locale = getLocale$1(localeKey) || this._locale;
        return this;
    };
    /**
     * @return {?}
    ...
    function (_units) {
        ...
        var /** @type {?} */ units = normalizeUnits$1(_units);
        if (units === 'month' || units === 'year') {
            days = this._days + milliseconds / 864e5;
            months = this._months + daysToMonths$1(days);
            return units === 'month' ? months : months / 12;
        }
        // handle milliseconds separately because of floating point math errors (issue #1867)
        days = this._days + Math.round(monthsToDays$1(this._months));
        switch (units) {
            case 'week':
                return days / 7 + milliseconds / 6048e5;
            case 'day':
    ...
    function () {
        ...
        return (this._milliseconds +
            this._days * 864e5 +
            (this._months % 12) * 2592e6 +
            toInt$1(this._months / 12) * 31536e6);
    };
    return Duration;
}());
/**
 ...
 * @return {?}
 */
function isValid$1(config) {
    if (config._isValid == null) {
        var /** @type {?} */ flags = getParsingFlags$1(config);
 ...
 * @return {?}
 */
function createInvalid$1(config, flags) {
    config._d = new Date(NaN);
    Object.assign(getParsingFlags$1(config), flags || { userInvalidated: true });
    return config;
}
/**
 * @param {?} config
...
// 0000-00-00 0000-W00 or 0000-W00-0 + T + 00 or 00:00 or 00:00:00 or 00:00:00.000 + +00:00 or +0000 or +00)
// tslint:disable-next-line
var /** @type {?} */ extendedIsoRegex$1 = /^\s*((?:[+-]\d{6}|\d{4})-(?:\d\d-\d\d|W\d\d-\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?::\d\d(?::\d\d(?:[.,]\d+)?)?)?)([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?$/;
// tslint:disable-next-line
var /** @type {?} */ basicIsoRegex$1 = /^\s*((?:[+-]\d{6}|\d{4})(?:\d\d\d\d|W\d\d\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?:\d\d(?:\d\d(?:[.,]\d+)?)?)?)([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?$/;
var /** @type {?} */ tzRegex$1 = /Z|[+-]\d\d(?::?\d\d)?/;
var /** @type {?} */ isoDates$1 = [
    ['YYYYYY-MM-DD', /[+-]\d{6}-\d\d-\d\d/, true],
    ['YYYY-MM-DD', /\d{4}-\d\d-\d\d/, true],
    ['GGGG-[W]WW-E', /\d{4}-W\d\d-\d/, true],
...
var /** @type {?} */ aspNetJsonRegex$1 = /^\/?Date\((\-?\d+)/i;
var /** @type {?} */ obsOffsets$1 = {
    UT: 0,
    GMT: 0,
    EDT: -4 * 60,
    EST: -5 * 60,
...
// RFC 2822 regex: For details see https://tools.ietf.org/html/rfc2822#section-3.3
// tslint:disable-next-line
var /** @type {?} */ rfc2822$1 = /^(?:(Mon|Tue|Wed|Thu|Fri|Sat|Sun),?\s)?(\d{1,2})\s(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)\s(\d{2,4})\s(\d\d):(\d\d)(?::(\d\d))?\s(?:(UT|GMT|[ECMP][SD]T)|([Zz])|([+-]\d{4}))$/;
/**
 * @param {?} config
 * @return {?}
 */
function configFromISO$1(config) {
    if (!isString$1(config._i)) {
        return config;
    }
    var /** @type {?} */ input = config._i;
    var /** @type {?} */ match = extendedIsoRegex$1.exec(input) || basicIsoRegex$1.exec(input);
    var /** @type {?} */ allowTime;
    var /** @type {?} */ dateFormat;
    var /** @type {?} */ timeFormat;
    var /** @type {?} */ tzFormat;
    ...
    var /** @type {?} */ i;
    var /** @type {?} */ l;
    for (i = 0, l = isoDates$1.length; i < l; i++) {
    ...
    if (match[3]) {
        for (i = 0, l = isoTimes$1.length; i < l; i++) {
    ...
    config._f = dateFormat + (timeFormat || '') + (tzFormat || '');
    return configFromStringAndFormat$1(config);
}
/**
 * @param {?} yearStr
 * @param {?} monthStr
 ...
 * @return {?}
 */
function preprocessRFC2822$1(str) {
    // Remove comments and folding whitespace and replace multiple-spaces with a single space
    return str
        .replace(/\([^)]*\)|[\n\t]/g, ' ')
        .replace(/(\s\s+)/g, ' ').trim();
...
function checkWeekday$1(weekdayStr, parsedInput, config) {
    if (weekdayStr) {
        // TODO: Replace the vanilla JS Date object with an indepentent day-of-week check.
        var /** @type {?} */ weekdayProvided = defaultLocaleWeekdaysShort$1.indexOf(weekdayStr);
...
function configFromRFC2822$1(config) {
    ...
    var /** @type {?} */ match = rfc2822$1.exec(preprocessRFC2822$1(config._i));
    if (!match) {
        return markInvalid$1(config);
    }
    var /** @type {?} */ parsedArray = extractFromRFC2822Strings$1(match[4], match[3], match[2], match[5], match[6], match[7]);
...
function configFromString$1(config) {
    ...
    var /** @type {?} */ matched = aspNetJsonRegex$1.exec(config._i);
    if (matched !== null) {
        config._d = new Date(+matched[1]);
        return config;
    }
 ...
 * @return {?}
 */
function formatDate$1(date, format, locale, isUTC, offset) {
    if (offset === void 0) { offset = 0; }
    var /** @type {?} */ _locale = getLocale$1(locale || 'en');
    if (!_locale) {
        throw new Error("Locale \"" + locale + "\" is not defined, please add it with \"defineLocale(...)\"");
    }
    var /** @type {?} */ _format = format || (isUTC ? 'YYYY-MM-DDTHH:mm:ss[Z]' : 'YYYY-MM-DDTHH:mm:ssZ');
    var /** @type {?} */ output = formatMoment$1(date, _format, _locale, isUTC, offset);
    if (!output) {
        return output;
    }
    return _locale.postformat(output);
 ...
 * @return {?}
 */
function formatMoment$1(date, _format, locale, isUTC, offset) {
    if (offset === void 0) { offset = 0; }
    if (!isDateValid$1(date)) {
        return locale.invalidDate;
    }
    var /** @type {?} */ format = expandFormat$1(_format, locale);
    formatFunctions$1[format] = formatFunctions$1[format] || makeFormatFunction$1(format);
    return formatFunctions$1[format](date, locale, isUTC, offset);
}
/**
 * @param {?} _format
 * @param {?} locale
 * @return {?}
 */
function expandFormat$1(_format, locale) {
...
function configFromArray$1(config) {
    ...
    // if the day of the year is set, figure out what it is
    if (config._dayOfYear != null) {
        yearToUse = defaults$1(config._a[YEAR$1], currentDate[YEAR$1]);
    ...
    if (config._a[HOUR$1] === 24 &&
        ...
        config._a[MILLISECOND$1] === 0) {
        config._nextDay = true;
        config._a[HOUR$1] = 0;
    }
    config._d = (config._useUTC ? createUTCDate$1 : createDate$1).apply(null, input);
    expectedWeekday = config._useUTC ? config._d.getUTCDay() : config._d.getDay();
    // Apply timezone offset from input. The actual utcOffset can be changed
    // with parseZone.
    if (config._tzm != null) {
...
function dayOfYearFromWeekInfo$1(config) {
    ...
    if (w.GG != null || w.W != null || w.E != null) {
        ...
        // a now version of current config (take local/utc/offset flags, and
        // create now).
        weekYear = defaults$1(w.GG, config._a[YEAR$1], weekOfYear$1(new Date(), 1, 4).year);
        ...
        dow = config._locale._week.dow;
        doy = config._locale._week.doy;
        var /** @type {?} */ curWeek = weekOfYear$1(new Date(), dow, doy);
        weekYear = defaults$1(w.gg, config._a[YEAR$1], curWeek.year);
        // Default to current week.
 ...
 * @return {?}
 */
function checkOverflow$1(config) {
    var /** @type {?} */ overflow;
    var /** @type {?} */ a = config._a;
    if (a && getParsingFlags$1(config).overflow === -2) {
        // todo: fix this sh*t
        overflow =
            a[MONTH$1] < 0 || a[MONTH$1] > 11 ? MONTH$1 :
                a[DATE$1] < 1 || a[DATE$1] > daysInMonth$1$1(a[YEAR$1], a[MONTH$1]) ? DATE$1 :
                    a[HOUR$1] < 0 || a[HOUR$1] > 24 || (a[HOUR$1] === 24 && (a[MINUTE$1] !== 0 || a[SECOND$1] !== 0 || a[MILLISECOND$1] !== 0)) ? HOUR$1 :
                        a[MINUTE$1] < 0 || a[MINUTE$1] > 59 ? MINUTE$1 :
                            a[SECOND$1] < 0 || a[SECOND$1] > 59 ? SECOND$1 :
                                a[MILLISECOND$1] < 0 || a[MILLISECOND$1] > 999 ? MILLISECOND$1 :
                                    -1;
        if (getParsingFlags$1(config)._overflowDayOfYear && (overflow < YEAR$1 || overflow > DATE$1)) {
            overflow = DATE$1;
        }
        if (getParsingFlags$1(config)._overflowWeeks && overflow === -1) {
            overflow = WEEK$1;
        }
        if (getParsingFlags$1(config)._overflowWeekday && overflow === -1) {
            overflow = WEEKDAY$1;
        }
        getParsingFlags$1(config).overflow = overflow;
    }
    return config;
}
...
// constant that refers to the ISO standard
// hooks.ISO_8601 = function () {};
var /** @type {?} */ ISO_8601$1 = 'ISO_8601';
// constant that refers to the RFC 2822 form
// hooks.RFC_2822 = function () {};
var /** @type {?} */ RFC_2822$1 = 'RFC_2822';
/**
 * @param {?} config
 * @return {?}
 */
function configFromStringAndFormat$1(config) {
    // TODO: Move this to another part of the creation flow to prevent circular deps
    if (config._f === ISO_8601$1) {
        return configFromISO$1(config);
    }
    if (config._f === RFC_2822$1) {
        return configFromRFC2822$1(config);
    }
    config._a = [];
    getParsingFlags$1(config).empty = true;
    if (isArray$1(config._f) || (!config._i && config._i !== 0)) {
        return config;
    }
    // This array is used to make a Date, either with `new Date` or `Date.UTC`
    ...
    var /** @type {?} */ tokens = expandFormat$1(config._f, config._locale).match(formattingTokens$1) || [];
    var /** @type {?} */ i;
    var /** @type {?} */ token;
    ...
    for (i = 0; i < tokens.length; i++) {
        token = tokens[i];
        parsedInput = (input.match(getParseRegexForToken$1(token, config._locale)) || [])[0];
        if (parsedInput) {
            skipped = input.substr(0, input.indexOf(parsedInput));
            if (skipped.length > 0) {
        ...
        // don't parse if it's not a known token
        if (formatTokenFunctions$1[token]) {
            if (parsedInput) {
                getParsingFlags$1(config).empty = false;
            }
            else {
                getParsingFlags$1(config).unusedTokens.push(token);
            }
            addTimeToArrayFromToken$1(token, parsedInput, config);
        }
        else if (config._strict && !parsedInput) {
            getParsingFlags$1(config).unusedTokens.push(token);
        }
    ...
    // add remaining unparsed input length to the string
    getParsingFlags$1(config).charsLeftOver = inputLength - totalParsedInputLength;
    if (input.length > 0) {
        getParsingFlags$1(config).unusedInput.push(input);
    }
    // clear _12h flag if hour is <= 12
    ...
    // handle meridiem
    config._a[HOUR$1] = meridiemFixWrap$1(config._locale, config._a[HOUR$1], config._meridiem);
    configFromArray$1(config);
    return checkOverflow$1(config);
}
/**
 * @param {?} locale
 * @param {?} _hour
 ...
 * @return {?}
 */
function meridiemFixWrap$1(locale, _hour, meridiem) {
    var /** @type {?} */ hour = _hour;
    if (meridiem == null) {
        // nothing to do
        return hour;
...
function configFromObject$1(config) {
    ...
    var /** @type {?} */ input = config._i;
    if (isObject$1(input)) {
        var /** @type {?} */ i = normalizeObjectUnits$1(/** @type {?} */ (input));
        config._a = [i.year, i.month, i.day, i.hours, i.minutes, i.seconds, i.milliseconds]
            .map(function (obj) { return isString$1(obj) ? parseInt(obj, 10) : obj; });
    }
    return configFromArray$1(config);
}
...
function createFromConfig$1(config) {
    var /** @type {?} */ res = checkOverflow$1(prepareConfig$1(config));
    // todo: remove, in moment.js it's never called cuz of moment constructor
    res._d = new Date(res._d != null ? res._d.getTime() : NaN);
    if (!isValid$1(Object.assign({}, res, { _isValid: null }))) {
        res._d = new Date(NaN);
    }
    // todo: update offset
    /*if (res._nextDay) {
...
function prepareConfig$1(config) {
    ...
    if (input === null || (format === undefined && input === '')) {
        return createInvalid$1(config, { nullInput: true });
    }
    if (isString$1(input)) {
        config._i = input = config._locale.preparse(input);
    }
    if (isDate$1(input)) {
        config._d = cloneDate$1(input);
        return config;
    }
    // todo: add check for recursion
    if (isArray$1(format)) {
...
function configFromInput$1(config) {
    ...
    else if (isArray$1(input) && input.length) {
        var /** @type {?} */ _arr = input.slice(0);
        config._a = _arr.map(function (obj) { return isString$1(obj) ? parseInt(obj, 10) : obj; });
        configFromArray$1(config);
    }
 ...
 * @return {?}
 */
function createLocalOrUTC$1(input, format, localeKey, strict, isUTC) {
    var /** @type {?} */ config = {};
    ...
    // }
    // todo: fail fast and return not valid date
    if ((isObject$1(_input) && isObjectEmpty$1(_input)) || (isArray$1(_input) && _input.length === 0)) {
        _input = undefined;
    }
    // object construction must be done this way.
    // https://github.com/moment/moment/issues/1423
    ...
    config._f = format;
    config._strict = strict;
    return createFromConfig$1(config);
}
 ...
 * @return {?}
 */
function parseDate$1(input, format, localeKey, strict, isUTC) {
    if (isDate$1(input)) {
        return input;
    }
    var /** @type {?} */ config = createLocalOrUTC$1(input, format, localeKey, strict, isUTC);
    return config._d;
}
 ...
 * @return {?}
 */
function isAfter$1(date1, date2, units) {
    ...
    return date2.valueOf() < startOf$1(date1, units).valueOf();
}
/**
 * @param {?} date1
 * @param {?} date2
 ...
 * @return {?}
 */
function isBefore$1(date1, date2, units) {
    if (units === void 0) { units = 'milliseconds'; }
    if (!date1 || !date2) {
        return false;
    }
    ...
    return endOf$1(date1, units).valueOf() < date2.valueOf();
}
/**
 * @param {?} date
 * @param {?} daysDisabled
 * @return {?}
 */
function isDisabledDay$1(date, daysDisabled) {
 ...
 * @suppress {checkTypes} checked by tsc
 */
var /** @type {?} */ aspNetRegex$1 = /^(\-|\+)?(?:(\d*)[. ])?(\d+)\:(\d+)(?:\:(\d+)(\.\d*)?)?$/;
// from http://docs.closure-library.googlecode.com/git/closure_goog_date_date.js.source.html
// somewhat more in line with 4.4.3.2 2004 spec, but allows decimal anywhere
// and further modified to allow for strings containing both week and day
// tslint:disable-next-line
var /** @type {?} */ isoRegex$1 = /^(-|\+)?P(?:([-+]?[0-9,.]*)Y)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)W)?(?:([-+]?[0-9,.]*)D)?(?:T(?:([-+]?[0-9,.]*)H)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)S)?)?$/;
/**
 * @param {?=} input
 * @param {?=} key
 * @param {?=} config
 * @return {?}
 */
function createDuration$1(input, key, config) {
    if (config === void 0) { config = {}; }
    var /** @type {?} */ duration = convertDuration$1(input, key);
    // matching against regexp is expensive, do it on demand
    return new Duration$1(duration, config);
}
/**
 * @param {?} input
 * @param {?} key
 * @return {?}
 */
function convertDuration$1(input, key) {
    // checks for null or undefined
    if (input == null) {
        return {};
    }
    ...
    if (isString$1(input)) {
        var /** @type {?} */ match = aspNetRegex$1.exec(input);
        if (match) {
            var /** @type {?} */ sign = (match[1] === '-') ? -1 : 1;
            return {
                year: 0,
                day: toInt$1(match[DATE$1]) * sign,
                hours: toInt$1(match[HOUR$1]) * sign,
                minutes: toInt$1(match[MINUTE$1]) * sign,
                seconds: toInt$1(match[SECOND$1]) * sign,
                // the millisecond decimal point is included in the match
                milliseconds: toInt$1(absRound$1(toInt$1(match[MILLISECOND$1]) * 1000)) * sign
            };
        }
        match = isoRegex$1.exec(input);
        if (match) {
            var /** @type {?} */ sign = (match[1] === '-') ? -1 : (match[1] === '+') ? 1 : 1;
            return {
                year: parseIso$1(match[2], sign),
                month: parseIso$1(match[3], sign),
                week: parseIso$1(match[4], sign),
                day: parseIso$1(match[5], sign),
                hours: parseIso$1(match[6], sign),
                minutes: parseIso$1(match[7], sign),
                seconds: parseIso$1(match[8], sign)
            };
        }
    }
    if (isObject$1(input) && ('from' in input || 'to' in input)) {
        var /** @type {?} */ diffRes = momentsDifference$1(parseDate$1(input.from), parseDate$1(input.to));
        return {
            milliseconds: diffRes.milliseconds,
            month: diffRes.months
        };
...
function positiveMomentsDifference$1(base, other) {
    ...
    res.months = getMonth$1(other) - getMonth$1(base) +
        (getFullYear$1(other) - getFullYear$1(base)) * 12;
    var /** @type {?} */ _basePlus = add$1(cloneDate$1(base), res.months, 'month');
    if (isAfter$1(_basePlus, other)) {
        --res.months;
    }
    res.milliseconds = +other - +(add$1(cloneDate$1(base), res.months, 'month'));
    return res;
}
/**
 * @param {?} base
...
function momentsDifference$1(base, other) {
    if (!(isDateValid$1(base) && isDateValid$1(other))) {
        return { milliseconds: 0, months: 0 };
    }
    var /** @type {?} */ res;
    var /** @type {?} */ _other = cloneWithOffset$1(other, base, { _offset: base.getTimezoneOffset() });
    if (isBefore$1(base, _other)) {
        res = positiveMomentsDifference$1(base, _other);
    }
    else {
        res = positiveMomentsDifference$1(_other, base);
        res.milliseconds = -res.milliseconds;
        res.months = -res.months;
    }
    return res;
 ...
 * @return {?}
 */
function add$1(date, val, period, isUTC) {
    var /** @type {?} */ dur = createDuration$1(val, period);
    return addSubtract$1(date, dur, 1, isUTC);
}
/**
 * @param {?} date
 * @param {?} val
 ...
 * @return {?}
 */
function subtract$1(date, val, period, isUTC) {
    var /** @type {?} */ dur = createDuration$1(val, period);
    return addSubtract$1(date, dur, -1, isUTC);
}
/**
 ...
 * @return {?}
 */
function addSubtract$1(date, duration, isAdding, isUTC) {
    var /** @type {?} */ milliseconds = duration._milliseconds;
    var /** @type {?} */ days = absRound$1(duration._days);
    var /** @type {?} */ months = absRound$1(duration._months);
    // todo: add timezones support
    // const _updateOffset = updateOffset == null ? true : updateOffset;
    if (months) {
        setMonth$1(date, getMonth$1(date, isUTC) + months * isAdding, isUTC);
    }
    if (days) {
        setDate$1(date, getDate$1(date, isUTC) + days * isAdding, isUTC);
    }
    if (milliseconds) {
        setTime$1(date, getTime$1(date) + milliseconds * isAdding);
    }
    return cloneDate$1(date);
    // todo: add timezones support
    // if (_updateOffset) {
    //   hooks.updateOffset(date, days || months);
    // }
 ...
 * @return {?}
 */
function parseWeekday$1(input, locale) {
    if (!isString$1(input)) {
        return input;
    }
 ...
 * @return {?}
 */
function parseIsoWeekday$1(input, locale) {
    if (locale === void 0) { locale = getLocale$1(); }
    if (isString$1(input)) {
        return locale.weekdaysParse(input) % 7 || 7;
    }
    return isNumber$1(input) && isNaN(input) ? null : input;
}
/**
 * @param {?} date
 * @param {?} input
 ...
 * @return {?}
 */
function setDayOfWeek$1(date, input, locale, isUTC) {
    if (locale === void 0) { locale = getLocale$1(); }
    var /** @type {?} */ day = getDay$1(date, isUTC);
    var /** @type {?} */ _input = parseWeekday$1(input, locale);
    return add$1(date, _input - day, 'day');
}
/**
 * @param {?} date
 * @param {?=} isUTC
 * @return {?}
 */
function getDayOfWeek$1(date, isUTC) {
    return getDay$1(date, isUTC);
}
/**
 * ****************************************
 * @param {?} date
 ...
 * @return {?}
 */
function getLocaleDayOfWeek$1(date, locale, isUTC) {
    if (locale === void 0) { locale = getLocale$1(); }
    return (getDay$1(date, isUTC) + 7 - locale.firstDayOfWeek()) % 7;
}
/**
 * @param {?} date
 * @param {?} input
 ...
 * @return {?}
 */
function setLocaleDayOfWeek$1(date, input, opts) {
    if (opts === void 0) { opts = {}; }
    var /** @type {?} */ weekday = getLocaleDayOfWeek$1(date, opts.locale, opts.isUTC);
    return add$1(date, input - weekday, 'day');
}
/**
 * @param {?} date
 * @param {?=} isUTC
 * @return {?}
 */
function getISODayOfWeek$1(date, isUTC) {
    return getDay$1(date, isUTC) || 7;
}
/**
 * @param {?} date
 * @param {?} input
 ...
 * @return {?}
 */
function setISODayOfWeek$1(date, input, opts) {
    if (opts === void 0) { opts = {}; }
    // behaves the same as moment#day except
    // as a getter, returns 7 instead of 0 (1-7 range instead of 0-6)
    // as a setter, sunday should belong to the previous week.
    ...
    setEventHandlers(container) {
        ...
        container.monthSelectHandler = (event) => {
            ...
            this._store.dispatch(this._actions.navigateTo({
                unit: {
                    month: getMonth$1(event.date),
                    year: getFullYear$1(event.date)
                },
                viewMode: 'day'
            }));
        };
...
MiniState = /** @class */ (function (_super) {
    ...
    function MiniState(_initialState, actionsDispatcher$, reducer) {
        ...
        var /** @type {?} */ actionInQueue$ = actionsDispatcher$.pipe(observeOn(queue));
...
function getStartingDayOfCalendar(date, options) {
    if (isFirstDayOfWeek$1(date, options.firstDayOfWeek)) {
        return date;
    }
    const weekDay = getDay$1(date);
    const offset = calculateDateOffset(weekDay, options.firstDayOfWeek);
    return shiftDate$1(date, { day: -offset });
}
...
function isMonthDisabled(date, min, max) {
    const minBound = min && isBefore$1(endOf$1(date, 'month'), min, 'day');
    const maxBound = max && isAfter$1(startOf$1(date, 'month'), max, 'day');
    return minBound || maxBound;
}
function isYearDisabled(date, min, max) {
    const minBound = min && isBefore$1(endOf$1(date, 'year'), min, 'day');
    const maxBound = max && isAfter$1(startOf$1(date, 'year'), max, 'day');
    return minBound || maxBound;
}
...
function createMatrix(options, fn) {
    ...
    for (let i = 0; i < options.height; i++) {
        ...
        for (let j = 0; j < options.width; j++) {
            ...
            prevValue = shiftDate$1(prevValue, options.shift);
        }
    }
    return matrix;
}
...
function calcDaysCalendar(startingDate, options) {
    const firstDay = getFirstDayOfMonth$1(startingDate);
...
function formatDaysCalendar(daysCalendar, formatOptions, monthIndex) {
    return {
        ...
        monthTitle: formatDate$1(daysCalendar.month, formatOptions.monthTitle, formatOptions.locale),
        yearTitle: formatDate$1(daysCalendar.month, formatOptions.yearTitle, formatOptions.locale),
        weekNumbers: getWeekNumbers(daysCalendar.daysMatrix, formatOptions.weekNumbers, formatOptions.locale),
        weekdays: getShiftedWeekdays(formatOptions.locale),
        weeks: daysCalendar.daysMatrix.map((week, weekIndex) => ({
            days: week.map((date, dayIndex) => ({
                date,
                label: formatDate$1(date, formatOptions.dayLabel, formatOptions.locale),
                monthIndex,
                weekIndex,
                dayIndex
            }))
...
function getWeekNumbers(daysMatrix, format, locale) {
    return daysMatrix.map((days) => (days[0] ? formatDate$1(days[0], format, locale) : ''));
}
function getShiftedWeekdays(locale) {
    const _locale = getLocale$1(locale);
...
function flagDaysCalendar(formattedMonth, options) {
    formattedMonth.weeks.forEach((week) => {
        ...
        week.days.forEach((day, dayIndex) => {
            // datepicker
            const isOtherMonth = !isSameMonth$1(day.date, formattedMonth.month);
            const isHovered = !isOtherMonth && isSameDay$2(day.date, options.hoveredDate);
            // date range picker
            const isSelectionStart = !isOtherMonth &&
                options.selectedRange &&
                isSameDay$2(day.date, options.selectedRange[0]);
            const isSelectionEnd = !isOtherMonth &&
                options.selectedRange &&
                isSameDay$2(day.date, options.selectedRange[1]);
            const isSelected = (!isOtherMonth && isSameDay$2(day.date, options.selectedDate)) ||
                isSelectionStart ||
                isSelectionEnd;
    ...
    formattedMonth.disableLeftArrow = isMonthDisabled(shiftDate$1(formattedMonth.month, { month: -1 }), options.minDate, options.maxDate);
    formattedMonth.disableRightArrow = isMonthDisabled(shiftDate$1(formattedMonth.month, { month: 1 }), options.minDate, options.maxDate);
...
function formatMonthsCalendar(viewDate, formatOptions) {
    const initialDate = startOf$1(viewDate, 'year');
    const matrixOptions = { width, height, initialDate, shift };
    const monthMatrix = createMatrix(matrixOptions, date => ({
        date,
        label: formatDate$1(date, formatOptions.monthLabel, formatOptions.locale)
    }));
    return {
        months: monthMatrix,
        monthTitle: '',
        yearTitle: formatDate$1(viewDate, formatOptions.yearTitle, formatOptions.locale)
    };
}
...
function flagMonthsCalendar(monthCalendar, options) {
    monthCalendar.months.forEach((months, rowIndex) => {
        months.forEach((month, monthIndex) => {
            const isHovered = isSameMonth$1(month.date, options.hoveredMonth);
            const isDisabled = options.isDisabled ||
    ...
    monthCalendar.hideRightArrow =
        options.monthIndex < options.displayMonths &&
            options.monthIndex + 1 !== options.displayMonths;
    monthCalendar.disableLeftArrow = isYearDisabled(shiftDate$1(monthCalendar.months[0][0].date, { year: -1 }), options.minDate, options.maxDate);
    monthCalendar.disableRightArrow = isYearDisabled(shiftDate$1(monthCalendar.months[0][0].date, { year: 1 }), options.minDate, options.maxDate);
...
function formatYearsCalendar(viewDate, formatOptions) {
    const initialDate = shiftDate$1(viewDate, { year: initialShift });
    ...
    const yearsMatrix = createMatrix(matrixOptions, date => ({
        date,
        label: formatDate$1(date, formatOptions.yearLabel, formatOptions.locale)
    }));
...
function formatYearRangeTitle(yearsMatrix, formatOptions) {
    const from = formatDate$1(yearsMatrix[0][0].date, formatOptions.yearTitle, formatOptions.locale);
    const to = formatDate$1(yearsMatrix[height$1 - 1][width$1 - 1].date, formatOptions.yearTitle, formatOptions.locale);
    return `${from} - ${to}`;
}
...
function flagYearsCalendar(yearsCalendar, options) {
    yearsCalendar.years.forEach((years, rowIndex) => {
        years.forEach((year, yearIndex) => {
            const isHovered = isSameYear$1(year.date, options.hoveredYear);
            const isDisabled = options.isDisabled ||
    ...
    yearsCalendar.disableLeftArrow = isYearDisabled(shiftDate$1(yearsCalendar.years[0][0].date, { year: -1 }), options.minDate, options.maxDate);
    const i = yearsCalendar.years.length - 1;
    const j = yearsCalendar.years[i].length - 1;
    yearsCalendar.disableRightArrow = isYearDisabled(shiftDate$1(yearsCalendar.years[i][j].date, { year: 1 }), options.minDate, options.maxDate);
...
function bsDatepickerReducer(state = initialDatepickerState, action) {
    switch (action.type) {
        ...
        case BsDatepickerActions.NAVIGATE_OFFSET: {
            const date = shiftDate$1(startOf$1(state.view.date, 'month'), action.payload);
            const newState = {
                view: {
        ...
        case BsDatepickerActions.NAVIGATE_TO: {
            ...
            const date = setFullDate$1(state.view.date, payload.unit);
            let newState;
            let mode;
        ...
        case BsDatepickerActions.SET_OPTIONS: {
            ...
            const _viewDate = isDateValid$1(newState.value) && newState.value
                || isArray$1(newState.value) && isDateValid$1(newState.value[0]) && newState.value[0]
                || state.view.date;
...
function calculateReducer(state) {
    ...
    if (state.view.mode === 'day') {
        state.monthViewOptions.firstDayOfWeek = getLocale$1(state.locale).firstDayOfWeek();
        const monthsModel = new Array(displayMonths);
        for (let monthIndex = 0; monthIndex < displayMonths; monthIndex++) {
            // todo: for unlinked calendars it will be harder
            monthsModel[monthIndex] = calcDaysCalendar(viewDate, state.monthViewOptions);
            viewDate = shiftDate$1(viewDate, { month: 1 });
        }
    ...
    if (state.view.mode === 'month') {
        ...
        for (let calendarIndex = 0; calendarIndex < displayMonths; calendarIndex++) {
            ...
            viewDate = shiftDate$1(viewDate, { year: 1 });
        }
    ...
    if (state.view.mode === 'year') {
        ...
        for (let calendarIndex = 0; calendarIndex < displayMonths; calendarIndex++) {
            ...
            viewDate = shiftDate$1(viewDate, { year: yearsPerCalendar });
        }
...
function formatReducer(state, action) {
    ...
    if (state.view.mode === 'year') {
        ...
        for (let calendarIndex = 0; calendarIndex < displayMonths; calendarIndex++) {
            // todo: for unlinked calendars it will be harder
            yearsCalendarModel[calendarIndex] = formatYearsCalendar(viewDate, getFormatOptions(state));
            viewDate = shiftDate$1(viewDate, { year: 16 });
        }
        return Object.assign({}, state, { yearsCalendarModel });
    }
    return state;
...
function getViewDate(viewDate, minDate, maxDate) {
    ...
    if (minDate && isAfter$1(minDate, _date, 'day')) {
        return minDate;
    }
    if (maxDate && isBefore$1(maxDate, _date, 'day')) {
        return maxDate;
    }
    return _date;
}
...
BsDatepickerContainerComponent.decorators = [
    { type: Component, args: [{
                ...
                template: "<!-- days calendar view mode --> <div class=\"bs-datepicker\" [ngClass]=\"containerClass\" *ngIf=\"viewMode | async\"> <div class=\"bs-datepicker-container\"> <!--calendars--> <div class=\"bs-calendar-container\" [ngSwitch]=\"viewMode | async\" role=\"application\"> <!--days calendar--> <div *ngSwitchCase=\"'day'\" class=\"bs-media-container\"> <bs-days-calendar-view *ngFor=\"let calendar of (daysCalendar | async)\" [class.bs-datepicker-multiple]=\"(daysCalendar | async)?.length > 1\" [calendar]=\"calendar\" [options]=\"options | async\" (onNavigate)=\"navigateTo($event)\" (onViewMode)=\"setViewMode($event)\" (onHover)=\"dayHoverHandler($event)\" (onHoverWeek)=\"weekHoverHandler($event)\" (onSelect)=\"daySelectHandler($event)\" ></bs-days-calendar-view> </div> <!--months calendar--> <div *ngSwitchCase=\"'month'\" class=\"bs-media-container\"> <bs-month-calendar-view *ngFor=\"let calendar of (monthsCalendar | async)\" [class.bs-datepicker-multiple]=\"(daysCalendar | async)?.length > 1\" [calendar]=\"calendar\" (onNavigate)=\"navigateTo($event)\" (onViewMode)=\"setViewMode($event)\" (onHover)=\"monthHoverHandler($event)\" (onSelect)=\"monthSelectHandler($event)\" ></bs-month-calendar-view> </div> <!--years calendar--> <div *ngSwitchCase=\"'year'\" class=\"bs-media-container\"> <bs-years-calendar-view *ngFor=\"let calendar of (yearsCalendar | async)\" [class.bs-datepicker-multiple]=\"(daysCalendar | async )?.length > 1\" [calendar]=\"calendar\" (onNavigate)=\"navigateTo($event)\" (onViewMode)=\"setViewMode($event)\" (onHover)=\"yearHoverHandler($event)\" (onSelect)=\"yearSelectHandler($event)\" ></bs-years-calendar-view> </div> </div> <!--applycancel buttons--> <div class=\"bs-datepicker-buttons\" *ngIf=\"false\"> <button class=\"btn btn-success\">Apply</button> <button class=\"btn btn-default\">Cancel</button> </div> </div> <!--custom dates or date ranges picker--> <div class=\"bs-datepicker-custom-range\" *ngIf=\"false\"> <bs-custom-date-view [ranges]=\"_customRangesFish\"></bs-custom-date-view> </div> </div> ",
                host: {
...
class BsDatepickerInputDirective {
    ...
    _setInputValue(value) {
        const initialDate = !value ? ''
            : formatDate$1(value, this._picker._config.dateInputFormat, this._localeService.currentLocale);
    ...
    validate(c) {
        ...
        if (isDate$1(_value)) {
            const _isDateValid = isDateValid$1(_value);
            if (!_isDateValid) {
                return { bsDate: { invalid: _value } };
            }
            if (this._picker && this._picker.minDate && isBefore$1(_value, this._picker.minDate, 'date')) {
                return { bsDate: { minDate: this._picker.minDate } };
            }
            if (this._picker && this._picker.maxDate && isAfter$1(_value, this._picker.maxDate, 'date')) {
    ...
    writeValue(value) {
        if (!value) {
            ...
            const _locale = getLocale$1(_localeKey);
            if (!_locale) {
                throw new Error(`Locale "${_localeKey}" is not defined, please add it with "defineLocale(...)"`);
            }
            this._value = parseDate$1(value, this._picker._config.dateInputFormat, this._localeService.currentLocale);
        }
...
class BsDaterangepickerInputDirective {
    ...
    _setInputValue(date) {
        ...
        if (date) {
            const start = !date[0] ? ''
                : formatDate$1(date[0], this._picker._config.rangeInputFormat, this._localeService.currentLocale);
            const end = !date[1] ? ''
                : formatDate$1(date[1], this._picker._config.rangeInputFormat, this._localeService.currentLocale);
    ...
    validate(c) {
        ...
        if (this._picker && this._picker.maxDate && isAfter$1(_value[1], this._picker.maxDate, 'date')) {
            return { bsDate: { maxDate: this._picker.maxDate } };
        }
    }
    registerOnValidatorChange(fn) {
    ...
    writeValue(value) {
        if (!value) {
            ...
            this._value = _input
                .map((_val) => parseDate$1(_val, this._picker._config.dateInputFormat, this._localeService.currentLocale))
...
class DateFormatter {
    format(date, format, locale) {
        return formatDate$1(date, format, locale);
    }
}
...
class ModalContainerComponent {
    ...
    ngOnInit() {
        ...
        setTimeout(() => {
            this.isShown = true;
            this._renderer.addClass(this._element.nativeElement, isBs3$1() ? CLASS_NAME.IN : CLASS_NAME.SHOW);
    ...
    hide() {
        ...
        this._renderer.removeClass(this._element.nativeElement, isBs3$1() ? CLASS_NAME.IN : CLASS_NAME.SHOW);
        setTimeout(() => {
            this.isShown = false;
            if (document &&
                document.body &&
...
class ModalDirective {
    ...
    show() {
        ...
        this.checkScrollbar();
        this.setScrollbar();
        if (document$1$1 && document$1$1.body) {
            if (document$1$1.body.classList.contains(CLASS_NAME.OPEN)) {
                this.isNested = true;
            }
            else {
                this._renderer.addClass(document$1$1.body, CLASS_NAME.OPEN);
            }
        }
        this.showBackdrop(() => {
            this.showElement();
    ...
    hide(event) {
        ...
        win$1.clearTimeout(this.timerHideModal);
        win$1.clearTimeout(this.timerRmBackDrop);
        this._isShown = false;
        ...
        if (this._config.animated) {
            this.timerHideModal = win$1.setTimeout(() => this.hideModal(), TRANSITION_DURATION);
        }
        else {
            this.hideModal();
        }
    ...
    showElement() {
        ...
        if (!this._element.nativeElement.parentNode ||
            ...
            if (document$1$1 && document$1$1.body) {
                document$1$1.body.appendChild(this._element.nativeElement);
            }
        }
    ...
    hideModal() {
        ...
        this.showBackdrop(() => {
            if (!this.isNested) {
                if (document$1$1 && document$1$1.body) {
                    this._renderer.removeClass(document$1$1.body, CLASS_NAME.OPEN);
                }
                this.resetScrollbar();
            }
    ...
    showBackdrop(callback) {
        if (this._isShown &&
            ...
            if (this.backdrop.instance.isAnimated) {
                this.timerRmBackDrop = win$1.setTimeout(callbackRemove, BACKDROP_TRANSITION_DURATION);
            }
            else {
                callbackRemove();
            }
    ...
    /** @internal */
    checkScrollbar() {
        this.isBodyOverflowing = document$1$1.body.clientWidth < win$1.innerWidth;
    ...
    setScrollbar() {
        ...
        this.originalBodyPadding = parseInt(win$1
            .getComputedStyle(document$1$1.body)
            .getPropertyValue('padding-right') || 0, 10);
        if (this.isBodyOverflowing) {
            document$1$1.body.style.paddingRight = `${this.originalBodyPadding +
                this.scrollbarWidth}px`;
        }
    }
    resetScrollbar() {
        document$1$1.body.style.paddingRight = `${this.originalBodyPadding}px`;
    }
    // thx d.walsh
    getScrollbarWidth() {
        const scrollDiv = this._renderer.createElement('div');
        this._renderer.addClass(scrollDiv, CLASS_NAME.SCROLLBAR_MEASURER);
        this._renderer.appendChild(document$1$1.body, scrollDiv);
        const scrollbarWidth = scrollDiv.offsetWidth - scrollDiv.clientWidth;
        this._renderer.removeChild(document$1$1.body, scrollDiv);
...
function changeTime(value, diff) {
    if (!value) {
        return changeTime(createDate$2(new Date(), 0, 0, 0), diff);
    }
    ...
    return createDate$2(value, hour, minutes, seconds);
}
function setTime$2(value, opts) {
    ...
    if (!value) {
        if (!isNaN(hour) && !isNaN(minute)) {
            return createDate$2(new Date(), hour, minute, seconds);
        }
        return value;
    }
    if (isNaN(hour) || isNaN(minute)) {
    ...
    return createDate$2(value, hour, minute, seconds);
}
function createDate$2(value, hours, minutes, seconds) {
...
function timepickerReducer(state = initialState, action) {
    switch (action.type) {
        ...
        case TimepickerActions.SET_TIME_UNIT: {
            ...
            const _newTime = setTime$2(state.value, action.payload);
            return Object.assign({}, state, { value: _newTime });
        }
...
const DEFAULT_ALIASES$1 = {
    hover: ['mouseover', 'mouseout'],
    focus: ['focusin', 'focusout']
};
/* tslint:disable-next-line: no-any */
function parseTriggers$1(triggers, aliases = DEFAULT_ALIASES$1) {
...
function listenToTriggersV2$1(renderer, options) {
    const parsedTriggers = parseTriggers$1(options.triggers);
...
function registerOutsideClick$1(renderer, options) {
    if (!options.outsideClick) {
        return Function.prototype;
    }
    /* tslint:disable-next-line: no-any */
...
/* tslint:disable-next-line: no-any */
function OnChange$1(defaultValue) {
    const sufix = 'Change';
    /* tslint:disable-next-line: no-any */
    return function OnChangeHandler(target, propertyKey) {
...
const _messagesHash$1 = {};
const _hideMsg$1 = typeof console === 'undefined' || !('warn' in console);
function warnOnce$1(msg) {
    if (!isDevMode() || _hideMsg$1 || msg in _messagesHash$1) {
        return;
    }
    _messagesHash$1[msg] = true;
    /*tslint:disable-next-line*/
    console.warn(msg);
}

class BsComponentRef$1 {
}
        ...
        if (content instanceof TemplateRef) {
            if (this._viewContainerRef) {
                const _viewRef = this._viewContainerRef
                    .createEmbeddedView(content, context);
                _viewRef.markForCheck();
                return new ContentRef$1([_viewRef.rootNodes], _viewRef);
            }
            const viewRef = content.createEmbeddedView({});
            this._applicationRef.attachView(viewRef);
            return new ContentRef$1([viewRef.rootNodes], viewRef);
        }
        if (typeof content === 'function') {
            ...
            Object.assign(componentRef.instance, initialState);
            this._applicationRef.attachView(componentRef.hostView);
            return new ContentRef$1([[componentRef.location.nativeElement]], componentRef.hostView, componentRef);
        }
        return new ContentRef$1([[this._renderer.createText(`${content}`)]]);
    }
}

class ComponentLoaderFactory$1 {
    ...
    /**
       ...
       */
    createLoader(_elementRef, _viewContainerRef, _renderer) {
        return new ComponentLoader$1(_viewContainerRef, _renderer, _elementRef, this._injector, this._componentFactoryResolver, this._ngZone, this._applicationRef, this._posService);
    }
}
ComponentLoaderFactory$1.decorators = [
    { type: Injectable },
];
/** @nocollapse */
ComponentLoaderFactory$1.ctorParameters = () => [
    { type: ComponentFactoryResolver, },
    { type: NgZone, },
    { type: Injector, },
    { type: PositioningService, },
...
class PositioningService$1 {
    position(options) {
        const { element, target, attachment, appendToBody } = options;
        positionElements$1(_getHtmlElement$1(target), _getHtmlElement$1(element), attachment, appendToBody);
    }
}
PositioningService$1.decorators = [
    { type: Injectable },
];
function _getHtmlElement$1(element) {
    // it means that we got a selector
    if (typeof element === 'string') {
        return document.querySelector(element);
    }
...
class MiniState$1 extends BehaviorSubject {
    constructor(_initialState, actionsDispatcher$, reducer) {
        super(_initialState);
        const actionInQueue$ = actionsDispatcher$.pipe(observeOn(queue));
...
class MiniStore$1 extends Observable {
    constructor(_dispatcher, /* tslint:disable-next-line: no-any */
    _reducer, /* tslint:disable-next-line: no-any */
    /* tslint:disable-next-line: no-any */
    state$) {
        super();
    ...
    lift(operator) {
        const store = new MiniStore$1(this._dispatcher, this._reducer, this);
        /* tslint:disable-next-line: deprecation */
        store.operator = operator;
        return store;
    }
...
let monthsParse$7 = [/^gen/i, /^feb/i, /^mar/i, /^abr/i, /^mai/i, /^jun/i, /^jul/i, /^ago/i, /^set/i, /^oct/i, /^nov/i, /^des/i];
let monthsRegex$6 = /^(gener|febrer|març|abril|maig|juny|juliol|agost|setembre|octubre|novembre|desembre|gen\.?|feb\.?|mar\.?|abr\.?|mai\.?|jun\.?|jul\.?|ago\.?|set\.?|oct\.?|nov\.?|des\.?)/i;
const caLocale$1 = {
    abbr: 'ca',
...
//! locale : Czech [cs]
//! author : petrbela : https://github.com/petrbela
const months$4 = 'leden_únor_březen_duben_květen_červen_červenec_srpen_září_říjen_listopad_prosinec'.split('_');
const monthsShort$8 = 'led_úno_bře_dub_kvě_čvn_čvc_srp_zář_říj_lis_pro'.split('_');
...
let monthsShortDot$6 = 'ene._feb._mar._abr._may._jun._jul._ago._sep._oct._nov._dic.'.split('_'), monthsShort$9 = 'ene_feb_mar_abr_may_jun_jul_ago_sep_oct_nov_dic'.split('_');
let monthsParse$8 = [/^ene/i, /^feb/i, /^mar/i, /^abr/i, /^may/i, /^jun/i, /^jul/i, /^ago/i, /^sep/i, /^oct/i, /^nov/i, /^dic/i];
let monthsRegex$7 = /^(enero|febrero|marzo|abril|mayo|junio|julio|agosto|septiembre|octubre|noviembre|diciembre|ene\.?|feb\.?|mar\.?|abr\.?|may\.?|jun\.?|jul\.?|ago\.?|sep\.?|oct\.?|nov\.?|dic\.?)/i;
const esDoLocale$1 = {
    abbr: 'es-do',
    months: 'enero_febrero_marzo_abril_mayo_junio_julio_agosto_septiembre_octubre_noviembre_diciembre'.split('_'),
    monthsShort(date, format, isUTC) {
        if (!date) {
            return monthsShortDot$6;
        }
        else if (/-MMM-/.test(format)) {
            return monthsShort$9[getMonth(date, isUTC)];
        }
        else {
            return monthsShortDot$6[getMonth(date, isUTC)];
        }
    },
...
let monthsShortDot$7 = 'ene._feb._mar._abr._may._jun._jul._ago._sep._oct._nov._dic.'.split('_'), monthsShort$10 = 'ene_feb_mar_abr_may_jun_jul_ago_sep_oct_nov_dic'.split('_');
let monthsParse$9 = [/^ene/i, /^feb/i, /^mar/i, /^abr/i, /^may/i, /^jun/i, /^jul/i, /^ago/i, /^sep/i, /^oct/i, /^nov/i, /^dic/i];
let monthsRegex$8 = /^(enero|febrero|marzo|abril|mayo|junio|julio|agosto|septiembre|octubre|noviembre|diciembre|ene\.?|feb\.?|mar\.?|abr\.?|may\.?|jun\.?|jul\.?|ago\.?|sep\.?|oct\.?|nov\.?|dic\.?)/i;
const esLocale$1 = {
    abbr: 'es',
    months: 'enero_febrero_marzo_abril_mayo_junio_julio_agosto_septiembre_octubre_noviembre_diciembre'.split('_'),
    monthsShort(date, format, isUTC) {
        if (!date) {
            return monthsShortDot$7;
        }
        if (/-MMM-/.test(format)) {
            return monthsShort$10[getMonth(date, isUTC)];
        }
        return monthsShortDot$7[getMonth(date, isUTC)];
    },
...
let monthsShortDot$8 = 'ene._feb._mar._abr._may._jun._jul._ago._sep._oct._nov._dic.'.split('_');
let monthsShort$11 = 'ene_feb_mar_abr_may_jun_jul_ago_sep_oct_nov_dic'.split('_');
const esUsLocale$1 = {
    abbr: 'es-us',
    months: 'enero_febrero_marzo_abril_mayo_junio_julio_agosto_septiembre_octubre_noviembre_diciembre'.split('_'),
    monthsShort(date, format, isUTC) {
        if (!date) {
            return monthsShortDot$8;
        }
        else if (/-MMM-/.test(format)) {
            return monthsShort$11[getMonth(date, isUTC)];
        }
        else {
            return monthsShortDot$8[getMonth(date, isUTC)];
        }
    },
    monthsParseExact: true,
    weekdays: 'domingo_lunes_martes_miércoles_jueves_viernes_sábado'.split('_'),
...
var numbersPast$1 = 'nolla yksi kaksi kolme neljä viisi kuusi seitsemän kahdeksan yhdeksän'.split(' '), numbersFuture$1 = [
...
function translate$8(num, withoutSuffix, key, isFuture) {
    ...
    result = verbalNumber$1(num, isFuture) + ' ' + result;
    return result;
}
function verbalNumber$1(num, isFuture) {
    return num < 10 ? (isFuture ? numbersFuture$1[num] : numbersPast$1[num]) : num;
}
const fiLocale$1 = {
    abbr: 'fi',
...
let monthsShortDot$9 = 'xan._feb._mar._abr._mai._xuñ._xul._ago._set._out._nov._dec.'.split('_'), monthsShort$12 = 'xan_feb_mar_abr_mai_xuñ_xul_ago_set_out_nov_dec'.split('_');
let monthsParse$10 = [/^xan/i, /^feb/i, /^mar/i, /^abr/i, /^mai/i, /^xuñ/i, /^xul/i, /^ago/i, /^set/i, /^out/i, /^nov/i, /^dec/i];
let monthsRegex$9 = /^(xaneiro|febreiro|marzo|abril|maio|xuño|xullo|agosto|setembro|outubro|novembro|decembro|xan\.?|feb\.?|mar\.?|abr\.?|mai\.?|xuñ\.?|xul\.?|ago\.?|set\.?|out\.?|nov\.?|dec\.?)/i;
const glLocale$1 = {
    abbr: 'gl',
    months: 'xaneiro_febreiro_marzo_abril_maio_xuño_xullo_agosto_setembro_outubro_novembro_decembro'.split('_'),
    monthsShort(date, format, isUTC) {
        if (!date) {
            return monthsShortDot$9;
        }
        if (/-MMM-/.test(format)) {
            return monthsShort$12[getMonth(date, isUTC)];
        }
        return monthsShortDot$9[getMonth(date, isUTC)];
    },
...
function week$1(date, isFuture) {
    return (isFuture ? '' : '[múlt] ') + '[' + weekEndings$1[getDayOfWeek(date)] + '] LT[-kor]';
}
const huLocale$1 = {
    abbr: 'hu',
    ...
    calendar: {
        ...
        nextWeek(date) {
            return week$1(date, true);
        },
        lastDay: '[tegnap] LT[-kor]',
        lastWeek(date) {
            return week$1(date, false);
        },
        sameElse: 'L'
    },
    relativeTime: {
...
let monthsParse$11 = [/^jan/i, /^feb/i, /^maart|mrt.?$/i, /^apr/i, /^mei$/i, /^jun[i.]?$/i, /^jul[i.]?$/i, /^aug/i, /^sep/i, /^okt/i, /^nov/i, /^dec/i];
let monthsRegex$10 = /^(januari|februari|maart|april|mei|april|ju[nl]i|augustus|september|oktober|november|december|jan\.?|feb\.?|mrt\.?|apr\.?|ju[nl]\.?|aug\.?|sep\.?|okt\.?|nov\.?|dec\.?)/i;
const nlBeLocale$1 = {
    abbr: 'nl-be',
    ...
    monthsShort(date, format, isUTC) {
        if (!date) {
            ...
            return monthsShortWithoutDots$2[getMonth(date, isUTC)];
        }
        else {
            return monthsShortWithDots$2[getMonth(date, isUTC)];
        }
    },
    monthsRegex: monthsRegex$10,
    monthsShortRegex: monthsRegex$10,
    monthsStrictRegex: /^(januari|februari|maart|mei|ju[nl]i|april|augustus|september|oktober|november|december)/i,
    monthsShortStrictRegex: /^(jan\.?|feb\.?|mrt\.?|apr\.?|mei|ju[nl]\.?|aug\.?|sep\.?|okt\.?|nov\.?|dec\.?)/i,
    monthsParse: monthsParse$11,
    longMonthsParse: monthsParse$11,
    shortMonthsParse: monthsParse$11,
...
let monthsParse$12 = [/^jan/i, /^feb/i, /^maart|mrt.?$/i, /^apr/i, /^mei$/i, /^jun[i.]?$/i, /^jul[i.]?$/i, /^aug/i, /^sep/i, /^okt/i, /^nov/i, /^dec/i];
let monthsRegex$11 = /^(januari|februari|maart|april|mei|april|ju[nl]i|augustus|september|oktober|november|december|jan\.?|feb\.?|mrt\.?|apr\.?|ju[nl]\.?|aug\.?|sep\.?|okt\.?|nov\.?|dec\.?)/i;
const nlLocale$1 = {
    abbr: 'nl',
    months: 'januari_februari_maart_april_mei_juni_juli_augustus_september_oktober_november_december'.split('_'),
    monthsShort(date, format, isUTC) {
    ...
    monthsRegex: monthsRegex$11,
    monthsShortRegex: monthsRegex$11,
    monthsStrictRegex: /^(januari|februari|maart|mei|ju[nl]i|april|augustus|september|oktober|november|december)/i,
    monthsShortStrictRegex: /^(jan\.?|feb\.?|mrt\.?|apr\.?|mei|ju[nl]\.?|aug\.?|sep\.?|okt\.?|nov\.?|dec\.?)/i,
    monthsParse: monthsParse$12,
    longMonthsParse: monthsParse$12,
    shortMonthsParse: monthsParse$12,
    weekdays: 'zondag_maandag_dinsdag_woensdag_donderdag_vrijdag_zaterdag'.split('_'),
    weekdaysShort: 'zo._ma._di._wo._do._vr._za.'.split('_'),
    weekdaysMin: 'zo_ma_di_wo_do_vr_za'.split('_'),
    weekdaysParseExact: true,
...
let monthsSubjective$1 = 'stycznia_lutego_marca_kwietnia_maja_czerwca_lipca_sierpnia_września_października_listopada_grudnia'.split('_');
...
function translate$12(num, withoutSuffix, key) {
    ...
    switch (key) {
        case 'ss':
            return result + (plural$5(num) ? 'sekundy' : 'sekund');
        case 'm':
            return withoutSuffix ? 'minuta' : 'minutę';
        case 'mm':
            return result + (plural$5(num) ? 'minuty' : 'minut');
        case 'h':
            return withoutSuffix ? 'godzina' : 'godzinę';
        case 'hh':
            return result + (plural$5(num) ? 'godziny' : 'godzin');
        case 'MM':
            return result + (plural$5(num) ? 'miesiące' : 'miesięcy');
        case 'yy':
            return result + (plural$5(num) ? 'lata' : 'lat');
    }
}
const plLocale$1 = {
    abbr: 'pl',
    months(date, format, isUTC) {
        if (!date) {
            return monthsNominative$1;
        }
        else if (format === '') {
            // Hack: if format empty we know this is used to generate
            // RegExp by moment. Give then back both valid forms of months
            // in RegExp ready format.
            return '(' + monthsSubjective$1[getMonth(date, isUTC)] + '|' + monthsNominative$1[getMonth(date, isUTC)] + ')';
        }
        else if (/D MMMM/.test(format)) {
            return monthsSubjective$1[getMonth(date, isUTC)];
        }
        else {
            return monthsNominative$1[getMonth(date, isUTC)];
        }
    },
...
function relativeTimeWithPlural$3(num, withoutSuffix, key) {
    ...
    return num + ' ' + plural$6(format[key], +num);
}
let monthsParse$13 = [/^янв/i, /^фев/i, /^мар/i, /^апр/i, /^ма[йя]/i, /^июн/i, /^июл/i, /^авг/i, /^сен/i, /^окт/i, /^ноя/i, /^дек/i];
...
const ruLocale$1 = {
    ...
    monthsParse: monthsParse$13,
    longMonthsParse: monthsParse$13,
    shortMonthsParse: monthsParse$13,
...
const months$5 = 'január_február_marec_apríl_máj_jún_júl_august_september_október_november_december'.split('_');
const monthsShort$13 = 'jan_feb_mar_apr_máj_jún_júl_aug_sep_okt_nov_dec'.split('_');
...
function translate$13(num, withoutSuffix, key, isFuture) {
    ...
    switch (key) {
        ...
        case 'ss':
            // 9 seconds / in 9 seconds / 9 seconds ago
            if (withoutSuffix || isFuture) {
                return result + (plural$7(num) ? 'sekundy' : 'sekúnd');
            }
            else {
                return result + 'sekundami';
            }
        ...
        case 'mm':
            // 9 minutes / in 9 minutes / 9 minutes ago
            if (withoutSuffix || isFuture) {
                return result + (plural$7(num) ? 'minúty' : 'minút');
            }
            else {
        ...
        case 'hh':
            // 9 hours / in 9 hours / 9 hours ago
            if (withoutSuffix || isFuture) {
                return result + (plural$7(num) ? 'hodiny' : 'hodín');
            }
            else {
                return result + 'hodinami';
            }
        ...
        case 'dd':
            // 9 days / in 9 days / 9 days ago
            if (withoutSuffix || isFuture) {
                return result + (plural$7(num) ? 'dni' : 'dní');
            }
            else {
                return result + 'dňami';
            }
        ...
        case 'MM':
            // 9 months / in 9 months / 9 months ago
            if (withoutSuffix || isFuture) {
                return result + (plural$7(num) ? 'mesiace' : 'mesiacov');
            }
            else {
        ...
        case 'yy':
            // 9 years / in 9 years / 9 years ago
            if (withoutSuffix || isFuture) {
                return result + (plural$7(num) ? 'roky' : 'rokov');
            }
            else {
                return result + 'rokmi';
            }
